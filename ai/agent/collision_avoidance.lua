...
function CollisionAvoidance:get_avoidance_force()
    -- 获得的力和速度正相关
    self:_init_speed()
    self:_init_ahead()
...
return {
    get_avoidance_force = function(agent, opts)
        return CollisionAvoidance:new(agent, opts):get_avoidance_force()
    end
}